...
urlpatterns = [
    ...
    path('accessorie/<slug:data>', views.accessorie, name='accessoriedata'),
    
    path('essentials/', views.essentials, name='essentials'),
    path('essentials/<slug:data>', views.essentials, name='essentialsdata'),

    path('beauty/', views.beauty, name='beauty'),
    path('beauty/<slug:data>', views.beauty, name='beautydata'),
